...
import { TouchableOpacity, StyleSheet, Text, View, Image, TextInput, Keyboard, Platform, ScrollView } from 'react-native';
...
class Login extends Component {
	...
	registe = () => {
		...
		console.log('registeParams: ', params);
	...
	render() {
		...
		return (
			<ScrollView style={{flex: 1, backgroundColor: Colors.White}}>
				<View style={{backgroundColor: '#7AD5A9', height: 160, alignItems: 'center'}}>
					<Image style={{ position: 'absolute' }} source={require('../../images/loginBG.png')} />
					<Header backgroundColor={Colors.transparent1}/>
					<View style={{flex: 1}} />
