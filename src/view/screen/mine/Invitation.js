...
class Invitation extends Component {
   ...
   */
    ...
    renderQRCode() {
        ...
        let qrcodeUrl = `${WEB_PATH}down?code=${invitCode}`;
        return (
            <View ref="shareViewShot" style={{flex: 1, backgroundColor: 'transparent' }}>
                <Image
                    source={require('../../images/inviter1.jpg')}
                    resizeMode={'stretch'}
                ...
                <View style={{position: 'absolute', backgroundColor: Colors.White, bottom: 10, height: 80, width: Metrics.screenWidth-40, marginHorizontal: 20, paddingLeft: 10, borderWidth: 1, borderColor: Colors.White, borderRadius: 5}}>
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 5}}>
                        ...
                        <View>
                            <Text style={{fontSize: 12, color: Colors.main, marginLeft: 10, fontWeight: 'bold'}}>HI! 我是{this.props.name} 我为哟哟吧代言</Text>
                            <Text style={{fontSize: 12, color: Colors.main, marginLeft: 10}}>扫描二维码 开启哟哟吧之旅...</Text>
                        </View>
                    </View>
