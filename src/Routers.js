...
import { View, Image, Text, InteractionManager, Platform, Modal, StyleSheet, TouchableOpacity, Linking } from 'react-native';
...
import FarmScreen from './view/screen/farm/FarmScreen';
import OldClothesAssess from './view/screen/main/assess/OldClothesAssess';
import ExchangeShop from './view/screen/main/exchange/ExchangeShop';
import AssessResults from './view/screen/main/assess/AssessResults';
import AssessCenter from './view/screen/main/assess/AssessCenter';
import GoodsDetail from './view/screen/main/exchange/GoodsDetail';
import ConfirmOrder from './view/screen/my/order/ConfirmOrder';
import SettingUp from './view/screen/my/setting/SettingUp';
import AddAddress from './view/screen/my/setting/AddAddress';
import Address from './view/screen/my/setting/Address';
import Team from './view/screen/my/team/Team';
import OrderList from './view/screen/my/order/OrderList';
import IntegralRecord from './view/screen/my/integral/IntegralRecord';
import CottonRecord from './view/screen/my/CottonRecord';
import WalletDetail from './view/screen/my/wallet/WalletDetail';
import TradeStore from './view/screen/main/assess/TradeStore';
import AssessOrderList from './view/screen/main/assess/AssessOrderList';
import AssessOrderDetail from './view/screen/main/assess/AssessOrderDetail';
import UserInfo from './view/screen/my/setting/UserInfo';
import EditUserInfo from './view/screen/my/setting/EditUserInfo';
import BusinessPwd from './view/screen/my/setting/BusinessPwd';
import EditSignInPwd from './view/screen/my/setting/EditSignInPwd';
import MessageDetail from './view/screen/info/MessageDetail';
import AccountInfo from './view/screen/my/setting/AccountInfo';
import CustomerService from './view/screen/my/CustomerService';
import PayPage from './view/screen/my/PayPage';
import IntegralExchange from './view/screen/my/integral/IntegralExchange';
import EmpowerScreen from './view/screen/empower/EmpowerScreen';
import AdDetail from './view/screen/digg/AdDetail';
import AdH5 from './view/screen/digg/AdH5';
import MyCommunity from './view/screen/my/community/MyCommunity';
            ...
            <Root>
                <Router headerMode="none">
                    <Scene key="root">
                        ...
                        <Scene key="EmpowerScreen" component={EmpowerScreen} />
                    ...
                    */}
                        ...
                        <Scene key="Password" component={Password} />
                        <Scene key="FarmScreen" component={FarmScreen}/>
                        <Scene key="OldClothes" component={OldClothesAssess}/>
                        <Scene key="ExchangeShop" component={ExchangeShop}/>
                        <Scene key="AssessResults" component={AssessResults}/>
                        <Scene key="AssessCenter" component={AssessCenter}/>
                        <Scene key="AssessOrderList" component={AssessOrderList}/>
                        <Scene key="AssessOrderDetail" component={AssessOrderDetail}/>
                        <Scene key="MessageDetail" component={MessageDetail}/>
                        ...
                        <Scene key="PayPage" component={PayPage} />
                        <Scene key="IntegralExchange" component={IntegralExchange} />
                        <Scene key="MyCommunity" component={MyCommunity} />
                        ...
                        <Scene key="IntegralRecord" component={IntegralRecord}/>
                        <Scene key="CottonRecord" component={CottonRecord}/>
                        <Scene key="WalletDetail" component={WalletDetail}/>
                        <Scene key="TradeStore" component={TradeStore}/>
...
const styles = StyleSheet.create({
    ...
    updateFooter: { marginTop: 15, marginBottom: 15, justifyContent: 'center', alignItems: 'center', alignSelf: 'center', height: 38, width: 180, backgroundColor: Colors.C16, borderRadius: 17 },
