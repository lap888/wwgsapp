                    ...
                    <ScrollView>
                        <View style={styles.card}>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={{ color: Colors.C8, fontSize: 12 }}>( {data.unitPrice}糖果{data.unitPrice}果皮兑换 1 份股权 )</Text>
                            </View>
...
const styles = StyleSheet.create({
    card: {minHeight: 200, backgroundColor: Colors.C6, marginHorizontal: 15, marginTop: 15, borderRadius: 10, padding: 10},
