...
export default class OrderDetail extends Component {
    ...
    render() {
        ...
        let dw = data.type == 0 ? '糖果' : data.type == 1 ? 'YB' : data.type == 2 ? 'USDT' : '';
                ...
                <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.card}>
                        ...
                        <View style={[styles.card3Item]}>
                            ...
                            <Text style={styles.card3RightTxt}>{dw} {data.amount * data.count}</Text>
                        </View>
                        <View style={styles.card3Item}>
                            <Text style={styles.card3LeftTxt}>运费:  </Text>
                            <Text style={styles.card3RightTxt}>USDT {data.postPrice}</Text>
                        </View>
                        <View style={styles.card3Item}>
                            <Text style={styles.card3LeftTxt}>实付金额:  </Text>
                            <Text style={styles.card3RightTxt}>{`${data.totalPrice} ${dw} + ${data.postPrice} USDT`}</Text>
                        </View>
                    </View>
                    <View style={styles.card}>
