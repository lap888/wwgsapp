...
import { View, Text, NativeModules, StatusBar, StyleSheet, ScrollView, TouchableWithoutFeedback, Linking, Image, Platform, TouchableOpacity, ImageBackground, SafeAreaView, ToastAndroid, Alert } from 'react-native';
...
let BASICINFO_BAR2 = [
	...
	{ key: "6", title: "股权换购", icon: 'address-book', router: 'EquityExchange' },
];
class Mine extends Component {
	...
	renderService() {
		return (
			<TouchableOpacity 
				...
				<Image source={require('../../images/mine/helpicon.png')}/>
				<Text style={{marginLeft: 5}}>帮助中心</Text>
			</TouchableOpacity>
		)
	}
	/**
	...
	renderHeaderCard = () => {
		return (
			<ImageBackground source={require('../../images/my1/headerbg.png')} resizeMode={'stretch'} style={{height: 133, paddingHorizontal: 10}}>
				<View style={{height: 40, flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5}}>
					<Text style={Styles.version}>{`版本号：${Env === 'dev' ? Env : ''}${Version}`}</Text>
					<View style={{flexDirection: 'row'}}>
						<TouchableOpacity style={{alignItems: 'center', marginRight: 10}} onPress={() => Actions.push('Message')}>
							<Image source={require('../../images/my1/xiaoxi.png')}/>
							<Text style={{fontSize: 9, color: Colors.White}}>消息</Text>
						</TouchableOpacity>
						<TouchableOpacity style={{alignItems: 'center'}} onPress={() => Actions.push(this.props.logged ? 'UserInfo' : 'Login')}>
							<Image source={require('../../images/my1/shezhi.png')}/>
	...
	renderUserCard = () => {
		...
		return (
			<View style={{ height: 132, backgroundColor: Colors.transparent, marginHorizontal: 10, marginTop: -80, paddingTop: 12}}>
			...
			<View style={Styles.transactionBody}>
				{TRANSACTION_BAR.map(item =>
					...
					<View style={Styles.barBodyItem}>
						...
						<Image source={require('../../images/my1/mai.png')} /> :
							item['router'] == 'SellOrder' ?
							<Image source={require('../../images/my1/maichu.png')} /> :
								item['router'] == 'BuyingOrder' ?
								<Image source={require('../../images/my1/jinxingzhong.png')} /> :
									item['router'] == 'BuyedOrder' ?
									<Image source={require('../../images/my1/yiwancheng.png')} /> :
	...
	renderLevelCard = () => {
		...
		return (
			<View style={{height: 70,backgroundColor: Colors.White, marginTop: 10, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 10}}>
				<ImageBackground resizeMode={'contain'} style={{width: Metrics.screenWidth-20, height: (Metrics.screenWidth-20)/6.74}} source={require('../../images/my1/gongxianbg.png')}>
			...
			<View style={Styles.barContainer}>
					...
					{BASICINFO_BAR.map(item =>
						<TouchableOpacity style={Styles.barBodyItem} key={item['key']} onPress={() => {
							...
							<View style={Styles.barBodyItem}>
								...
								<Image source={require('../../images/my1/shimingrenzheng.png')} /> :
									item['router'] == 'MyTeam' ?
									<Image source={require('../../images/my1/wodetuandui.png')} /> :
										item['router'] == 'Invitation' ?
										<Image source={require('../../images/my1/yaoqinghaoyou.png')} /> :
											<FontAwesome name={item['icon']} color={Colors.C6} size={28} />
								}
								<Text style={Styles.barText}>{item['title']}</Text>
							</View>
				...
				<View style={Styles.barBody}>
					{BASICINFO_BAR2.map(item =>
						...
						<TouchableOpacity style={Styles.barBodyItem} key={item['key']} onPress={() =>  Actions.push(this.props.logged ? item['router'] : 'Login') }>
							<View style={Styles.barBodyItem}>
							{item['router'] == 'CityShow' ?
								<Image source={require('../../images/my1/chengshidating.png')} /> :
								item['router'] == 'PayPage2' ?
								<Image source={require('../../images/mine/ercirenzheng.png')} /> :
									item['router'] == 'Adress' ?
									<Image source={require('../../images/my1/dizhiguanli.png')} /> :
										item['router'] == 'EquityExchange' ?
										<Image source={require('../../images/my1/guquanhuangou.png')} /> :
											<FontAwesome name={item['icon']} color={Colors.C6} size={28} />
							}
							<Text style={Styles.barText}>{item['title']}</Text>
							</View>
	...
	renderYoBangCard = () => {
		...
		return (
			<View style={Styles.yoContainer}>
				<View style={Styles.barHeader}>
					<Text style={Styles.barTitle}>——管理——</Text>
				</View>
				<View style={Styles.barBody}>
					{SERVICE_BAR.map(item =>
						...
						<View style={Styles.barBodyItem}>
							...
							<Image source={require('../../images/my1/xuanshangguanli.png')} /> :
								item['router'] == 'MyYoTask' ?
								<Image source={require('../../images/my1/woderenwu.png')} /> :
									item['router'] == 'YoTaskApeal' ?
									<Image source={require('../../images/my1/jubaoweiquan.png')} /> :
										item['router'] == 'BindWeChat' ?
										<Image source={require('../../images/my1/bindWeChat.png')} /> :
											<FontAwesome name={item['icon']} color={Colors.C6} size={28} />
							}
							<Text style={Styles.barText}>{item['title']}</Text>
						</View>
...
const Styles = StyleSheet.create({
	...
	barTitle: { fontSize: 12, color: Colors.fontColor, fontWeight: '500' },
