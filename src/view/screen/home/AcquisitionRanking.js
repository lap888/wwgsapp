                    ...
                    // <View style={}>
                        ...
                        <View style={Styles.miningItemHeader}>
                            ...
                            <View style={{ marginLeft: 10 }}>
                                ...
                                {this.state.type == 1 && <Text style={Styles.miningItemGemin}>{`本月收购: ${item.duplicate}单`}</Text>}
                            </View>
                        </View>
                    </LinearGradient>
                    // </View>
            ...
            <View style={{ flex: 1, backgroundColor: '#fff' }} >
                ...
                <View style={{flexDirection: 'row', height: 50, borderBottomWidth: 1, borderBottomColor: Colors.C13}}>
                    ...
                    <TouchableOpacity style={{flex: 1, alignItems: 'center' }} onPress={() => this.select(1)}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={this.state.type == 1 ? { color: Colors.C6, fontSize: 18 } : { color: Colors.C11, fontSize: 14 }}>月榜</Text>
                        </View>
