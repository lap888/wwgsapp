...
const ImageArray = [
    { key: "positiveUrl", title: "身份证正面照示例", temp: require('../../images/positive.png') },
    { key: "negativeUrl", title: "身份证反面照示例", temp: require('../../images/negative.png') },
    { key: "characterUrl", title: "      人像照示例      ", temp: require('../../images/character.png') },
];
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity style={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, justifyContent: 'center', alignItems: 'center' }} onPress={() => this.handelPreviewImage({ uri: this.state[item['key']] })}>
                                        <View style={{ transform: [{ rotateZ: '45deg' }] }}>
                                            <Text allowFontScaling={false} style={{ fontSize: 16, color: Colors.C6, fontWeight: '500' }}>哟哟吧实名审核</Text>
                                        </View>
                                    </TouchableOpacity>
                                    {this.props.auditState !== 1 && this.props.auditState !== 2 &&
