        ...
        return (
            ...
            >
                <View style={styles.tipsView}>
                    ...
                    <View style={{backgroundColor: Colors.White, height: 250, paddingHorizontal: 15, paddingTop: 15}}>
                        <View>
                            <Image style={{width: 70, height: 70 }}  source={{uri: data.shopPic1}}/>
                        </View>
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 30}}>
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'center', marginBottom: 20}}>
                            ...
                            <View style={{width: 10}}/>
                            <TouchableOpacity style={{flex: 1, height: 40, borderRadius: 20, backgroundColor: Colors.main, borderRadius: 20, justifyContent: 'center', alignItems: 'center'}} onPress={this.enterOrder}>
