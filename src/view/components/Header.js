...
export default class Header extends Component {
    ...
    static defaultProps = {
        ...
        style: {},
        statusBarBackgroundColor: Colors.headerBgColor,
                ...
                <View style={Styles.leftContainer}>
                    {!isTabBar ?
                        (leftText ?
                            ...
                            :
                            <Icon name={leftIcon} size={leftIconSize} color={Colors.fontColor} />
                        )
                        : <View />
                    }
                </View>
            ...
            <TouchableWithoutFeedback onPress={() => onRightPress()}>
                <View style={Styles.rightContainer}>
                    {rightText ?
                        ...
                        :
                        (rightIcon ?
                            <Icon name={rightIcon} size={rightIconSize} color={Colors.fontColor} />
                            :
                            <View />
                        )
                    }
...
const Styles = StyleSheet.create({
    ...
    titleStyle: { fontSize: 17, color: '#030303', fontWeight: 'normal' },
    ...
    rightStyle: { fontSize: 16, color: Colors.fontColor, fontWeight: 'normal' },
});
