 ...
 * @Last Modified time: 2020-05-16 15:44:08
 */
...
//2.message title
const Message_Mock = [
    { id: 0, title: '哟哟吧今日上线公测' },
    { id: 2, title: '关于星级达人的问题' }
];
const Message2_Mock = [
    { id: 0, title: '哟哟吧今日上线公测', tCreatAt: '2019-12-20 20:00:00' },
    { id: 2, title: '关于星级达人的问题', tCreatAt: '2019-12-21 20:00:00' }
];
//3.message detail
const Message_Detail_Mock = { id: 1, cerated_at: '2019-12-21 20:00:00', content: '哟哟吧今日上线公测 欢迎大家积极反馈' };
...
// 首页功能Buttun
const HOME_OPTIONS = [
    { key: 0, name: "旧衣评估", route: 'OldClothes', icon: 'graduation-cap', image: require('../view/images/home/jiuyipingu.png')},
    { key: 1, name: "兑换商城", route: 'ExchangeShop', icon: 'tasks', image: require('../view/images/home/duihuanSC.png')},
    { key: 2, name: "棉宝公益", route: 'NULL', icon: 'trophy', image:  require('../view/images/home/mianbaoGY.png')},
    { key: 3, name: "精彩待续", route: 'NULL', icon: 'barcode',  image: require('../view/images/home/gengduo.png')},
