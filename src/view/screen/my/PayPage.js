            ...
            <View style={{ backgroundColor: Colors.White, flex: 1 }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    <View style={{ marginTop: 60, marginBottom: 40, alignItems: 'center' }}>
                        ...
                        <Text style={{ color: Colors.main, fontWeight: 'bold', marginTop: 20, fontSize: 20 }}>实名认证</Text>
                    ...
                    {/* <TouchableOpacity
                        ...
                        <Text style={{ fontSize: 18, marginLeft: 20 }}>{`使用新人券认证`}</Text>
                    </TouchableOpacity> */}
                    <TouchableOpacity style={styles.alipayBtn} onPress={this.aliPay} >
...
const styles = StyleSheet.create({
    ...
    btnView: { borderRadius: 25, marginTop: 10, borderColor: Colors.main, borderWidth: 1, height: 50, width: Metrics.screenWidth * 0.7, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' },
