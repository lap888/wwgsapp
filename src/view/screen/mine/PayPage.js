            ...
            <View style={{ backgroundColor: Colors.White, flex: 1 }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    <View style={{ marginTop: 60, marginBottom: 40, alignItems: 'center' }}>
                        <Icon name="idcard" color={Colors.C6} size={80} />
...
const Styles = StyleSheet.create({
    ...
    btnView: { borderRadius: 25, marginTop: 10, borderColor: Colors.Alipay, borderWidth: 1, height: 50, width: Metrics.screenWidth * 0.7, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' },
});
