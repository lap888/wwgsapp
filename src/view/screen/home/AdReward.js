...
import { View, Text, StyleSheet, Platform, Animated, BackHandler, TouchableOpacity, Image } from 'react-native';
...
class AdReward extends Component {
    constructor(props) {
        super(props);
        this.state = {
            height: 0,
                ...
                <View>
                    ...
                    <View style={{ alignItems: "center", height: Metrics.screenHeight }}>
                        ...
                        <WebView
                            ...
                            source={Platform.OS === 'android' ? { uri: this.props.url, baseUrl: "", headers: { token: this.props.token } } : { uri: this.props.url, headers: { token: this.props.token } }}
                        />
                    </View>
                </View>
            )
...
export default connect(mapStateToProps, mapDispatchToProps)(AdReward)
// 样式
