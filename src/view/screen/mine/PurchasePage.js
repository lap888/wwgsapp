 ...
 * @Last Modified time: 2020-03-28 19:48:28
 */
...
// import { Header, Body, Title, Icon, Toast } from 'native-base';
...
class PurchasePage extends Component {
    ...
    confirmObtainedBuyTransaction() {
        ...
        Send(`api/Trade/CancleTrade?orderNum=${this.state.itemId}&tradePwd=${this.state.tradePwd}`, {}, 'get').then(res => {
            ...
            Toast.tipTop(res.code == 200 ? "买单下架成功" : res.message)
            // Toast.show({
            //     text: res.code == 200 ? "买单下架成功" : res.message,
